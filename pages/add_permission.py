...
class AddPermission:
    def __init__(self, root):
        ...
        Label(frame,text="Add a permission from user",font=Font2,bg='lightblue').place(x=250,y=20)
        ...
        Button(frame, text='   Clear   ', bg='purple', font=Font2, fg='white', command=self.clear_fields).place(x=130,
                                                                                                                y=290)
        Button(frame, text='   Add permission   ', bg='teal', font=Font2, fg='white',
        command=self.add_permission).place(x=300,y=290)
        frame.place(x=0,y=0)
    ...
    def add_permission(self):
        ...
        perms.add_permission(self.permission.get(),self.username.get())
        self.clear_fields()